  ...
  group(
    ...
    () {
        ...
        () {
          test(
            ...
            () async {
              ...
              // act
              final result = await localDataSource.deleteExpiredAt();
        ...
        () {
          test(
            ...
            () async {
              ...
              // act
              final result = await localDataSource.deleteProfile();
      ...
      group(
        'getExpiredAt',
        () {
          final expiredAt = DateTime.now().add(const Duration(hours: 5));
          test(
            ...
            () async {
              ...
              // act
              final result = await localDataSource.getExpiredAt();
      ...
      group(
        ...
        () {
          test(
            ...
            () async {
              // arrange
              final jsonString = fixture('profile_fixture.json');
        ...
        () {
          ...
          test(
            ...
            () async {
              ...
              // act
              final result = await localDataSource.saveProfile(profile);
        ...
        () {
          test(
            ...
            () async {
              ...
              // act
              final result = await localDataSource.updateExpiredAt();
